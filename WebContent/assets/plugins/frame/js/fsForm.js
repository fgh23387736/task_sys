  ...
  FsForm = function (){
    ...
    var thisForm = this;
		...
		function showData(formData){
			...
			$(thisForm.config.elem).find("input").each(function(){		
				var _name = $(this).attr("name");
				var _subName = $(this).attr("sub-name");
				console.log(_subName);
				if(_subName != undefined){
					formData[_name] = formData[_name][_subName];
				}
			});
