...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../assets/plugins/layui/css/layui.mobile.css" media="all"/>
...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-header">
    <a href="./index.jsp" class="layui-hide-xs"><div class="layui-logo">便捷校园</div></a>
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;">
        	<img src="${user.headImg}" class="layui-nav-img">
         	${user.name}
        </a>
        <dl class="layui-nav-child">
          <dd><a href="javascript:$('[menuId=\'personalInformation\']').click();">基本资料</a></dd>
          <dd class="layui-hide-sm"><a href="javascript:signOut()"><i class="fa fa-sign-out"></i> 退出</a></dd>
        </dl>
      </li>
      <li class="layui-nav-item layui-hide-xs"><a href="javascript:signOut()"><i class="fa fa-sign-out"></i> 退出</a></li>
    </ul>
  </div>
...
<audio id="messageSound">
    <source = src="/task_sys/assets/sounds/message.mp3" type="audio/mp3">
</audio>
</html>
<div id="task-box" style="display:none;background: white; width: 300px;padding:10px;font-family: '微软雅黑';">
  <div style="height:204px;">
    <div style="border-radius: 3px;border: 2px solid rgba(0,0,0,0.5);width:100px;margin:0 auto;">
  ...
  <div id="task-box-content" style=" width: 100%;height: 100px;">
     <table class="layui-table" lay-skin="row" lay-even>
        <tr>
          <td width="30">任务</td>
          <td id="task-box-name">21111111</td>
        </tr>
        <tr><td>描述</td><td id="task-box-content-content"></td></tr>
     </table>
  </div>
</div>
