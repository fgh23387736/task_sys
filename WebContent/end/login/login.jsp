			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="/task_sys/end/assets/img/logo-dark.png" alt="Klorofil Logo" style="width:50%;"></div>
							...
							<form class="form-auth-small" action="#">
								...
								<div class="btn btn-warning btn-lg btn-block" onclick="window.location = '/task_sys/end/register/register.jsp';">注册</div>
