...
function submitTest() {
    ...
    if (type == 1) {
      layer.load(2);
      $.ajax({
          url: '/task_sys/actions/user_login.action',
          type: 'POST',
          dataType: 'json',
          data: {
              userName: username,
          ...
          success: function(data) {
            ...
            window.location = "/task_sys/end/user/index.jsp";
          },
          error: function(data) {
      ...
      layer.load(2);
      $.ajax({
          url: '/task_sys/actions/admin_login.action',
          type: 'POST',
          dataType: 'json',
          data: {
              userName: username,
          ...
          success: function(data) {
              ...
              layer.closeAll('loading');
              window.location = "/task_sys/end/admin/index.jsp";
          },
          error: function(data) {
              layer.closeAll('loading');
              if(data.responseJSON != undefined) {
