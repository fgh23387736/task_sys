layui.use(["layer"],function(){
    ...
    function init(){
        ...
        layer.load(2);
        $.ajax({
            url: '/task_sys/actions/special_adminGetWebInfo.action',
            type: 'GET',
            dataType: 'json',
            data: {
            },
            success: function(data) {
                ...
                document.getElementById('TaskNumber').innerHTML=data.taskNumber;
                document.getElementById('SystemMoney').innerHTML=data.systemMoney;
                document.getElementById('SuspenedNumber').innerHTML=data.suspenedUserNumber;
